...
class Inchoo_SocialConnect_VkController extends Inchoo_SocialConnect_Controller_Abstract
{

    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        Mage::helper('inchoo_socialconnect/vk')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            /** @var Inchoo_SocialConnect_Helper_Vk $helper */
            $helper = Mage::helper('inchoo_socialconnect/vk');

            // Facebook API green light - proceed
            /** @var Inchoo_SocialConnect_Model_Vk_Info $info */
            $info = Mage::getModel('inchoo_socialconnect/vk_info');

            $token = $info->getClient()->getAccessToken($code);

            $info->load();

            $customersByVkId = $helper->getCustomersByVkId($info->getId());
