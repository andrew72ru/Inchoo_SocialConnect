...
class Inchoo_SocialConnect_Model_Vk_Info_User extends Inchoo_SocialConnect_Model_Vk_Info
{
     ...
     * @return Inchoo_SocialConnect_Model_Vk_Userinfo
     */
    public function load($id = null)
    {
        ...
        if(!($socialconnectVkid = $this->customer->getInchooSocialconnectVkid()) ||
                !($socialconnectVktoken = $this->customer->getInchooSocialconnectVktoken())) {
            return $this;
        }
    ...
    protected function _onException($e) {
        ...
        /* @var $helper Inchoo_SocialConnect_Helper_Vk */
