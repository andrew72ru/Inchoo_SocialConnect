...
class Inchoo_SocialConnect_Model_Vk_Oauth2_Client
{
     ...
     * @return mixed
     * @throws \Exception
     * @throws \Inchoo_SocialConnect_Model_Vk_Oauth2_Exception
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new Inchoo_SocialConnect_Model_Vk_Oauth2_Exception($message);
            } else {
                $message = sprintf(
                    Mage::helper('inchoo_socialconnect')
        ...
        Mage::log($decodedResponse->response[0], null, 'vk_debug.log');
//        Mage::log(var_export($decodedResponse, true), null, 'vk_debug.log');
